...
internal sealed partial class ClientApplication : IAsyncDisposable
{
    ...
    private static readonly IReadOnlyDictionary<string, string> HelpUsageOverrides =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["me"] = "/me <action>",
            ["describe"] = "/describe <target> <action>",
            ["ame"] = "/ame <action>",
            ["amsg"] = "/amsg <message>",
            ["query"] = "/query <nick> [message]",
            ["ctcp"] = "/ctcp <nick> <command> [arguments]",
            ["raw"] = "/raw <IRC command>",
            ...
            ["ban"] = "/ban <nick|hostmask>",
            ["banlist"] = "/banlist [channel]",
            ["addban"] = "/addban <nick|hostmask> <channel[,channel...]|*> [reason]",
            ["bans"] = "/bans",
            ["remban"] = "/remban <hostmask|id>",
            ["kickban"] = "/kickban <nick> [reason]",
            ["tban"] = "/tban <nick-or-mask> <duration> [--reason <text>]",
            ["mmode"] = "/mmode <+|-mode> <nick> [nick ...]",
            ["ufind"] = "/ufind [channel]",
            ["filterkickban"] = "/filterkickban <hostmask> [reason]",
            ["findnickkick"] = "/findnickkick <wildcard> [reason]",
            ["kicknonops"] = "/kicknonops [reason]",
            ["cop"] = "/cop <nick>",
            ["cban"] = "/cban <nick>",
            ["ckick"] = "/ckick <nick> [reason]",
            ["ckb"] = "/ckb <nick> [reason]",
            ["massinvite"] = "/massinvite <channel>",
            ["inviteall"] = "/inviteall <nick>",
            ["wall"] = "/wall <message>",
            ["wallmsg"] = "/wallmsg <message>",
            ["voicenotice"] = "/voicenotice <message>",
            ["voicemsg"] = "/voicemsg <message>",
            ["nonopmsg"] = "/nonopmsg <message>",
            ["userwall"] = "/userwall <message>",
            ["users"] = "/users",
            ["names"] = "/names [channel]",
            ...
            ["chattr"] = "/chattr <handle> <flags> [channel]",
            ["addchan"] = "/addchan <handle> <channel>",
